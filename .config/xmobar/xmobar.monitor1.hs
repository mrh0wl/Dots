Config
  { font = "xft:Ubuntu Nerd Font:weight=bold:pixelsize=11:antialias=true:hinting=true",
    ...
    allDesktops = True,
    persistent = True,
    iconRoot = "/home/mrh0wl/.xmonad/xpm/",
    commands =
      [ Run UnsafeStdinReader,
        ...
        Run Com "/home/mrh0wl/.local/bin/battery.sh" [""] "bat" 50,
        Run Com "/home/mrh0wl/.local/bin/layout.sh" [""] "layout" 50,
        Run Com "/home/mrh0wl/.local/bin/trayerpad.sh" [] "trayerpad" 20,
        Run Com "/home/mrh0wl/.local/bin/debupdate.sh" [] "debupdate" 36000,
